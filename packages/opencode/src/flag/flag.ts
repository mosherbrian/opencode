...
export const Flag = {
  ...
  VOLTCODE_DISABLE_SHARE: truthy("VOLTCODE_DISABLE_SHARE"),
  VOLTCODE_DISABLE_MODELS_FETCH: truthy("VOLTCODE_DISABLE_MODELS_FETCH"),
  VOLTCODE_DISABLE_AUTOUPDATE: truthy("VOLTCODE_DISABLE_AUTOUPDATE"),
